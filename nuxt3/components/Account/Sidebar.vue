        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div
                class="flex grow flex-col gap-y-5 overflow-y-auto dark:bg-gray-900 px-6 pb-4 ring-1 ring-white/10"
              >
                <div class="flex h-16 shrink-0 items-center justify-center">
                  <NuxtLink to="/account" @click="uiStore.closeSidebar()">
                    <BaseLogo />
                  </NuxtLink>
                </div>
...
import { HomeIcon, UsersIcon, XMarkIcon, Cog6ToothIcon } from "@heroicons/vue/24/outline";
...
const navigation = [
  ...
  { name: "Users", href: "/account/users", icon: UsersIcon },
];
</script>
